...
#define BASIC_TOKEN_FLOATVAR	0x04u		/* Simple reference to a floating point variable */
#define BASIC_TOKEN_STRINGVAR	0x05u		/* Simple reference to a string variable */
