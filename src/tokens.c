...
static token tokens [] = {
  ...
  {"FALSE",     5, 2, TYPE_ONEBYTE,  BASTOKEN_FALSE,      TYPE_ONEBYTE,  BASTOKEN_FALSE,      TRUE,  FALSE}, /* 49 */
  ...
  {"GCOL",      4, 2, TYPE_ONEBYTE,  BASTOKEN_GCOL,       TYPE_ONEBYTE,  BASTOKEN_GCOL,       FALSE, FALSE}, /* 54 */
  ...
  {"HIMEM",     5, 1, TYPE_FUNCTION, BASTOKEN_HIMEM,      TYPE_FUNCTION, BASTOKEN_HIMEM,      TRUE,  FALSE}, /* 59 */
  {"IF",        2, 2, TYPE_ONEBYTE,  BASTOKEN_XIF,        TYPE_ONEBYTE,  BASTOKEN_XIF,        FALSE, FALSE}, /* 60 */
  ...
  {"LEFT$(",    6, 2, TYPE_FUNCTION, BASTOKEN_LEFT,       TYPE_FUNCTION, BASTOKEN_LEFT,       FALSE, FALSE}, /* 66 */
  ...
  {"LIBRARY",   7, 3, TYPE_ONEBYTE,  BASTOKEN_LIBRARY,    TYPE_ONEBYTE,  BASTOKEN_LIBRARY,    FALSE, FALSE}, /* 69 */
  ...
  {"MID$(",     5, 1, TYPE_FUNCTION, BASTOKEN_MID,        TYPE_FUNCTION, BASTOKEN_MID,        FALSE, FALSE}, /* 75 */
  ...
  {"NEXT",      4, 1, TYPE_ONEBYTE,  BASTOKEN_NEXT,       TYPE_ONEBYTE,  BASTOKEN_NEXT,       FALSE, FALSE}, /* 81 */
  {"NOT",       3, 3, TYPE_ONEBYTE,  BASTOKEN_NOT,        TYPE_ONEBYTE,  BASTOKEN_NOT,        FALSE, FALSE},
  {"OFF",       3, 3, TYPE_ONEBYTE,  BASTOKEN_OFF,        TYPE_ONEBYTE,  BASTOKEN_OFF,        FALSE, FALSE}, /* 83 */
  {"OF",        2, 2, TYPE_ONEBYTE,  BASTOKEN_OF,         TYPE_ONEBYTE,  BASTOKEN_OF,         FALSE, FALSE},
  {"ON",        2, 2, TYPE_ONEBYTE,  BASTOKEN_ON,         TYPE_ONEBYTE,  BASTOKEN_ON,         FALSE, FALSE}, /* 85 */
  ...
  {"OR",        2, 2, TYPE_ONEBYTE,  BASTOKEN_OR,         TYPE_ONEBYTE,  BASTOKEN_OR,         FALSE, FALSE}, /* 90 */
  ...
  {"PAGE",      4, 2, TYPE_FUNCTION, BASTOKEN_PAGE,       TYPE_FUNCTION, BASTOKEN_PAGE,       TRUE,  FALSE}, /* 94 */
  ...
  {"PRINT",     5, 1, TYPE_ONEBYTE,  BASTOKEN_PRINT,      TYPE_ONEBYTE,  BASTOKEN_PRINT,      FALSE, FALSE}, /* 102 */
  ...
  {"QUIT",      4, 1, TYPE_ONEBYTE,  BASTOKEN_QUIT,       TYPE_ONEBYTE,  BASTOKEN_QUIT,       TRUE,  FALSE}, /* 105 */
  {"RAD",       3, 2, TYPE_FUNCTION, BASTOKEN_RAD,        TYPE_FUNCTION, BASTOKEN_RAD,        FALSE, FALSE}, /* 106 */
  ...
  {"REPORT",    6, 4, TYPE_ONEBYTE,  BASTOKEN_REPORT,     TYPE_ONEBYTE,  BASTOKEN_REPORT,     TRUE,  FALSE}, /* 112 */
  ...
  {"SGN",       3, 2, TYPE_FUNCTION, BASTOKEN_SGN,        TYPE_FUNCTION, BASTOKEN_SGN,        FALSE, FALSE}, /* 119 */
  ...
  {"SQR",       3, 3, TYPE_FUNCTION, BASTOKEN_SQR,        TYPE_FUNCTION, BASTOKEN_SQR,        FALSE, FALSE}, /* 123 */
  ...
  {"STRING$(",  8, 4, TYPE_FUNCTION, BASTOKEN_STRING,     TYPE_FUNCTION, BASTOKEN_STRING,     FALSE, FALSE}, /* 128 */
  ...
  {"TAB(",      4, 4, TYPE_PRINTFN,  BASTOKEN_TAB,        TYPE_PRINTFN,  BASTOKEN_TAB,        FALSE, FALSE}, /* 133 */
  ...
  {"TINT",      4, 3, TYPE_ONEBYTE,  BASTOKEN_TINT,       TYPE_ONEBYTE,  BASTOKEN_TINT,       FALSE, FALSE}, /* 138 */
  ...
  {"UNTIL",     5, 1, TYPE_ONEBYTE,  BASTOKEN_UNTIL,      TYPE_ONEBYTE,  BASTOKEN_UNTIL,      FALSE, FALSE}, /* 142 */
  {"USR",       3, 2, TYPE_FUNCTION, BASTOKEN_USR,        TYPE_FUNCTION, BASTOKEN_USR,        FALSE, FALSE},
  {"VAL",       3, 2, TYPE_FUNCTION, BASTOKEN_VAL,        TYPE_FUNCTION, BASTOKEN_VAL,        FALSE, FALSE}, /* 144 */
  ...
  {"WAIT",      4, 2, TYPE_ONEBYTE,  BASTOKEN_WAIT,       TYPE_ONEBYTE,  BASTOKEN_WAIT,       TRUE,  FALSE}, /* 150 */
  ...
  {"XLATE$(",   7, 2, TYPE_FUNCTION, BASTOKEN_XLATEDOL,   TYPE_FUNCTION, BASTOKEN_XLATEDOL,   FALSE, FALSE}, /* 154 */
/*
...
*/
  {"APPEND",    6, 2, TYPE_COMMAND, BASTOKEN_APPEND,    TYPE_COMMAND,  BASTOKEN_APPEND,    FALSE, FALSE}, /* 155 */
  {"AUTO",      4, 2, TYPE_COMMAND, BASTOKEN_AUTO,      TYPE_COMMAND,  BASTOKEN_AUTO,      FALSE, FALSE},
  {"CRUNCH",    6, 2, TYPE_COMMAND, BASTOKEN_CRUNCH,    TYPE_COMMAND,  BASTOKEN_CRUNCH,    FALSE, FALSE}, /* 157 */
  {"DELETE",    6, 3, TYPE_COMMAND, BASTOKEN_DELETE,    TYPE_COMMAND,  BASTOKEN_DELETE,    FALSE, FALSE}, /* 158 */
  {"EDITO",     5, 5, TYPE_COMMAND, BASTOKEN_EDITO,     TYPE_COMMAND,  BASTOKEN_EDITO,     FALSE, FALSE}, /* 159 */
  {"EDIT",      4, 2, TYPE_COMMAND, BASTOKEN_EDIT,      TYPE_COMMAND,  BASTOKEN_EDIT,      FALSE, FALSE},
  {"HELP",      4, 2, TYPE_COMMAND, BASTOKEN_HELP,      TYPE_COMMAND,  BASTOKEN_HELP,      TRUE,  FALSE}, /* 161 */
  {"INSTALL",   7, 5, TYPE_COMMAND, BASTOKEN_INSTALL,   TYPE_COMMAND,  BASTOKEN_INSTALL,   FALSE, FALSE}, /* 162 */
  {"LISTB",     5, 5, TYPE_COMMAND, BASTOKEN_LISTB,     TYPE_COMMAND,  BASTOKEN_LISTB,     FALSE, FALSE}, /* 163 */
  ...
  {"NEW",       3, 3, TYPE_COMMAND, BASTOKEN_NEW,       TYPE_COMMAND,  BASTOKEN_NEW,       TRUE,  FALSE}, /* 171 */
  {"OLD",       3, 1, TYPE_COMMAND, BASTOKEN_OLD,       TYPE_COMMAND,  BASTOKEN_OLD,       TRUE,  FALSE}, /* 172 */
  {"QUIT",      4, 1, TYPE_ONEBYTE, BASTOKEN_QUIT,      TYPE_ONEBYTE,  BASTOKEN_QUIT,      TRUE,  FALSE}, /* 173 */
  {"RENUMBER",  8, 3, TYPE_COMMAND, BASTOKEN_RENUMBER,  TYPE_COMMAND,  BASTOKEN_RENUMBER,  FALSE, FALSE}, /* 174 */
  {"RUN",       3, 2, TYPE_ONEBYTE, BASTOKEN_RUN,       TYPE_ONEBYTE,  BASTOKEN_RUN,       TRUE,  FALSE},
  {"SAVEO",     5, 5, TYPE_COMMAND, BASTOKEN_SAVEO,     TYPE_COMMAND,  BASTOKEN_SAVEO,     FALSE, FALSE}, /* 176 */
  {"SAVE",      4, 2, TYPE_COMMAND, BASTOKEN_SAVE,      TYPE_COMMAND,  BASTOKEN_SAVE,      FALSE, FALSE},
  {"TEXTLOAD",  8, 3, TYPE_COMMAND, BASTOKEN_TEXTLOAD,  TYPE_COMMAND,  BASTOKEN_TEXTLOAD,  FALSE, FALSE}, /* 178 */
